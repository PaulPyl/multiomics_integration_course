...
**This document is in essence identical to the one linked on the MOFA webpage with some minor modifications. Find the original here: https://raw.githack.com/bioFAM/MOFA2_tutorials/master/R_tutorials/CLL.html**
...
usePrecomputed <- TRUE #Change this if you want to run the computation yourself ... it will take some time
